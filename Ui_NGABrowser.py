...
#
# Created: Mon Aug 10 15:30:21 2015
...
class Ui_NGABrowserWidget(object):
    def setupUi(self, NGABrowserWidget):
        ...
        NGABrowserWidget.resize(487, 727)
        ...
        self.gridLayout.addWidget(self.pButtonCatalog, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.frameUsable, 2, 1, 1, 1)
        self.metadata = QtGui.QTableWidget(NGABrowserWidget)
        ...
        self.gridLayout.addWidget(self.metadata, 0, 0, 1, 2)
